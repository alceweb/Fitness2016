...
namespace FitnessMVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CategoryID,Title,Description,Path")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CategoryID,Title,Description,Path")] Product product)
        {
            if (ModelState.IsValid)
            {

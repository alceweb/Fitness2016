        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                if (model.Email != "cesare@cr-consult.eu")
                {
                    ...
                    message.Body = "Il giorno <strong>" + DateTime.Now + "</strong><br/><strong>" + model.Email + "</strong><br/>ha eseguito l'accesso al sito di <strong>Personal Trainer Test.</strong>";
                ...
                default:
                    if (model.Email != "cesare@cr-consult.eu")
                    {
                        ...
                        message.To.Add(new MailAddress("cesare@cr-consult.eu"));
                        message.Subject = "Accesso al sito del karate";
                        message.Body = "Il giorno <strong>" + DateTime.Now + "</strong><br/><strong>" + model.Email + "</strong><br/> ha tentato di accedere al sito di <strong>Personal Trainer Test. Accesso negato!!!</strong>";
                        message.IsBodyHtml = true;
                        using (var smtp = new SmtpClient())
                        {
                            await smtp.SendMailAsync(message);
